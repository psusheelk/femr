...
import femr.common.IItemPatientModelMapper;
import femr.common.ItemPatientModelMapper;
...
public class SearchService implements ISearchService {
    ...
    private final IItemPatientModelMapper itemPatientModelMapper;
    ...
    public SearchService(IRepository<IConceptDiagnosis> diagnosisRepository,
                         ...
                         @Named("identified") IItemModelMapper itemModelMapper, @Named("identified") ItemPatientModelMapper itemPatientModelMapper) {
        ...
        this.itemPatientModelMapper = itemPatientModelMapper;
    ...
    public ServiceResponse<PatientEncounterItem> retrievePatientEncounterItemByEncounterId(int encounterId) {
        ...
        try {
            IPatientEncounter patientEncounter = patientEncounterRepository.findOne(patientEncounterQuery);
            PatientEncounterItem patientEncounterItem = itemPatientModelMapper.createPatientTestEncounterItem(patientEncounter);
    ...
    public ServiceResponse<PatientEncounterItem> retrieveRecentPatientEncounterItemByPatientId(int patientId) {
        ...
        try {
            ...
            PatientEncounterItem patientEncounterItem = itemPatientModelMapper.createPatientTestEncounterItem(currentPatientEncounter);
            response.setResponseObject(patientEncounterItem);
    ...
    public ServiceResponse<List<PatientEncounterItem>> retrievePatientEncounterItemsByPatientId(int patientId) {
        ...
        try {
            ...
            for (IPatientEncounter pe : patientEncounters) {
                patientEncounterItems.add(itemPatientModelMapper.createPatientTestEncounterItem(pe));
            }
